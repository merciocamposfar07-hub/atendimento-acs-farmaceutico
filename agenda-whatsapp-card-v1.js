...
function injectRefreshButton(){
  var ids=['atualizarPaginaAgendas','atualizarPaginaAgendasFlutuante','portalTacsAtualizarPaginaV1','portalTacsAdminRefreshV1'];
  ids.forEach(function(id){var n=document.getElementById(id);if(n&&n.parentNode)n.parentNode.removeChild(n)});
}
