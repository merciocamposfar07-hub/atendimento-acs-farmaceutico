...
const requiredStatic = [
  ...
  'test_onesignal_health_autorecovery_v1.js',
  'test_onesignal_service_worker_isolation_v1.js',
  'test_interface_action_gate_v1.js',
...
const requiredBrowser = [
  'homologacao-central-scroll-stability.spec.js',
...
console.log('REGRESSAO_INTEGRAL_V1_OK: desempenho, navegação, área, família, Push, reserva, ações, rolagem e Safari permanecem obrigatórios no gate final.');
