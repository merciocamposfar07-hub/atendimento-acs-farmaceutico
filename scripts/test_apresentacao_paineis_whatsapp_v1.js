...
assert.match(central,/agenda-whatsapp-card-v1\.js\?v=20260913-agendas-ios-mount-v1/);
assert.match(central,/conecta-agendas-native-v1\.js\?v=20260913-agendas-ios-mount-v1/);
