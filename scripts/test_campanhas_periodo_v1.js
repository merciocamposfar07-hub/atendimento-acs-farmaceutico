...
assert(wrapper.includes('campanhas-periodo-v1.js?v=20260816-periodo-v1'), 'Painel oficial: extensão mensal não é carregada');
...
assert(portal.includes("ctx.font = '800 44px"), 'Portal: tipografia ampliada do card não encontrada');
...
assert(municipal.includes('portalTacsContrasteV1'), 'Municípios: contraste persistente ausente');

console.log('Campanhas/portal V1: OK — período anual/mensal, card profissional, feedback municipal e atenção pública validados.');
