...
# manter uma guarda explícita para ambientes com DOM mínimo.
p = Path('admin-warmup.js')
text = p.read_text(encoding='utf-8')
needle = "  'use strict';\n\n"
guard = "  'use strict';\n\n  if(typeof document==='undefined'||typeof document.getElementById!=='function'||typeof document.createElement!=='function'||!document.head)return;\n\n"
