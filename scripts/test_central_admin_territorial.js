...
assert.match(js,/teste-v1\/painel-tacs-areas-v1\.html\?from=central&localfirst=1&v=/,
  'A Central deve carregar diretamente o painel real de TACS/áreas, em local-first e com revisão explícita de cache.');
