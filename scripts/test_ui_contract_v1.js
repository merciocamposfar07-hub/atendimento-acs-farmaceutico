...
assert(/CONTRAST_KEY='portalTacsContrasteV1'/.test(centralJs), 'Central: chave persistente de contraste ausente');
...
console.log('UI contract V1: OK — azul-petróleo, contraste centralizado, módulos e proteção de overflow conferidos.');
