...
assert.match(territorioHtml,/conecta-module-core-v1\.js\?v=20260913-territorio-first-touch-v2/);
assert.match(territorioHtml,/painel-tacs-areas-v1\.js\?v=20260913-territorio-first-touch-ubs-cache-v2/);
assert.match(wrapper,/painel-tacs-areas-v1\.html\?v=20260913-territorio-first-touch-ubs-cache-v2/);
