...
async function testTerritoryPanel() {
  ...
  const official = source('painel-oficial-tacs-areas.html');
  ...
  assert.match(html, /painel-tacs-areas-v1\.js\?v=20260913-territorio-first-touch-ubs-cache-v2/,'HTML e JS da UBS devem compartilhar a revisão atual.');
  assert.match(official, /painel-tacs-areas-v1\.html\?v=20260913-territorio-first-touch-ubs-cache-v2/,'Wrapper oficial deve buscar o HTML atual da UBS.');
