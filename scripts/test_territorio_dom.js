...
async function testTerritoryPanel() {
  ...
  assert.match(html, /painel-tacs-areas-v1\.js\?v=20260913-territorio-contexto-local-v4/,'HTML e JS da UBS devem compartilhar a revisão atual.');
  assert.match(official, /painel-tacs-areas-v1\.html\?v=20260913-territorio-contexto-local-v4/,'Wrapper oficial deve buscar o HTML atual da UBS.');
