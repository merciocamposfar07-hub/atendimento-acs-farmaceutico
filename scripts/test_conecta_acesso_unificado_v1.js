...
assert(unified.includes("conecta_ubs_identificar_primeiro_acesso"),'Primeiro acesso UBS deve confirmar o cadastro');
assert(backend.includes("conecta_ubs_identificar_primeiro_acesso"),'Backend unificado deve reconhecer o primeiro acesso UBS');
assert(backend.includes("conecta_ubs_login_pin"),'Backend unificado deve suportar o segundo acesso UBS por PIN após a Tarefa 4');
