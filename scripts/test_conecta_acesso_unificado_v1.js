...
assert(unified.includes("conecta_ubs_identificar_primeiro_acesso"),'Primeiro acesso UBS deve confirmar o cadastro sem criar sessão exclusiva ainda');
assert(backend.includes("conecta_ubs_identificar_primeiro_acesso"),'Backend unificado deve reconhecer o primeiro acesso UBS');
assert(backend.includes("vinculoAparelhoCriado:false"),'Tarefa 1 não deve vincular permanentemente o aparelho UBS');
