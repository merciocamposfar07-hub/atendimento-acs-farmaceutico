(function(){
  ...
  function loadFamilyIdentification(){
    ...
    script.async=true;
    script.src='/atendimento-acs-farmaceutico/portal-identificacao-familia-v1.js?v=20260918-familia-snapshot-pronto-v6';
  ...
  function loadInstitutionalPortal(){
    ...
    if(!existing){
      ...
      script.async=false;
      script.src='/atendimento-acs-farmaceutico/portal-institucional-suporte-v1.js?v=20260918-footer-icon-align-v4';
