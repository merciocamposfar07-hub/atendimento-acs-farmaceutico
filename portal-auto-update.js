(function(){
  ...
  function loadFamilyIdentification(){
    ...
    script.async=true;
    script.src='/atendimento-acs-farmaceutico/portal-identificacao-familia-v1.js?v=20260915-familia-cache-ponta-a-ponta-v8';
  ...
  function loadInstitutionalPortal(){
    ...
    if(!existing){
      ...
      script.async=false;
      script.src='/atendimento-acs-farmaceutico/portal-institucional-suporte-v1.js?v=20260913-seta-historica-centralizada-v1';
