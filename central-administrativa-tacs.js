...
if(token||territoryToken){setStatus('Conferindo a sessão existente…','warn');loadContext('Sessão existente validada.')}else{showLogin(TACS_ONLY?'tacs':'admin')}
}());
