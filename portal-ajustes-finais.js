(function () {
  ...
  function addStyles() {
    ...
    style.textContent = [
      ...
      '.tacs-petroleum-button{width:100%;min-height:82px;border:0;border-radius:18px;padding:16px 20px;background:#062c46;color:#fff;font-size:21px;font-weight:950;line-height:1.22;cursor:pointer;box-shadow:none}',
