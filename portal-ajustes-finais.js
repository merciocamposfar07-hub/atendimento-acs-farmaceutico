(function () {
  ...
  function addStyles() {
    ...
    style.textContent = [
      ...
      '.tacs-petroleum-button{width:100%;min-height:82px;border:1px solid rgba(255,255,255,.28);border-radius:18px;padding:16px 20px;background:#062c46;color:#fff;font-size:21px;font-weight:950;line-height:1.22;cursor:pointer;box-shadow:none}',
      ...
      '.notification-guide-all{margin-top:14px;padding:14px;border:0;border-radius:0;background:#062c46;color:#dceaf0}',
      '.notification-guide-all strong{display:block;margin-bottom:8px;color:#fff;font-size:17px}',
      '.notification-guide-all p{margin:7px 0;font-size:15px;line-height:1.5}',
      'html body .content{background:#062c46!important;background-image:none!important;border:0!important;box-shadow:none!important}',
      'html body .form-panel{background:transparent!important;background-image:none!important;border:0!important;box-shadow:none!important}',
      'html body .tacs-send-options,html body .notification-offer,html body .notification-guide-all,html body .portal-service-picker-panel,html body .portal-attachment-box,html body #retirementRecipientBoxV1{background:#062c46!important;background-image:none!important;border:0!important;box-shadow:none!important}',
      'html body .form-panel input,html body .form-panel textarea,html body .form-panel select{background:transparent!important;background-image:none!important;border:1px solid rgba(255,255,255,.28)!important;box-shadow:none!important;color:#fff!important}',
      'html body .tacs-petroleum-button,html body .tacs-card-button,html body .notification-offer button,html body .notification-offer .notification-repair{background:#062c46!important;background-image:none!important;border:1px solid rgba(255,255,255,.28)!important;box-shadow:none!important;color:#fff!important}',
      '@keyframes cscPetroleumSendReadyPulse{0%,100%{transform:scale(1);box-shadow:0 0 0 2px rgba(112,227,159,.20),0 0 12px rgba(112,227,159,.18)}50%{transform:scale(1.022);box-shadow:0 0 0 4px rgba(112,227,159,.30),0 0 28px rgba(112,227,159,.42)}}',
      'html body #sendPetroleumCard.tacs-petroleum-button:not(:disabled){background:#0b5b3c!important;background-image:none!important;border:2px solid #70e39f!important;color:#fff!important;opacity:1!important;animation:cscPetroleumSendReadyPulse 1.05s ease-in-out infinite!important;transform-origin:center!important;box-shadow:0 0 0 2px rgba(112,227,159,.20),0 0 16px rgba(112,227,159,.25)!important;filter:brightness(1.08)!important;-webkit-filter:brightness(1.08)!important}',
      'html body #sendPetroleumCard.tacs-petroleum-button:not(:disabled) small{color:#e1ffec!important}',
      '@media(prefers-reduced-motion:reduce){html body #sendPetroleumCard.tacs-petroleum-button:not(:disabled){animation:none!important;transform:none!important}}',
      'html body #send.send{background:#062c46!important;background-image:none!important;border:2px solid #70e39f!important;box-shadow:none!important;color:#fff!important}',
      'html body .before-send{display:none!important}',
      'html body .notification-offer h3,html body .notification-offer p,html body .notification-offer .notification-status,html body .notification-offer .notification-help{color:#dceaf0!important}',
      'html body #retirementRecipientBoxV1 h3{color:#fff!important}',
