(function () {
  ...
  function addStyles() {
    ...
    style.textContent = [
      ...
      'html body .content,html body .form-panel{background:#062c46!important;background-image:none!important;border:0!important;box-shadow:none!important}',
      ...
      'html body .form-panel input,html body .form-panel textarea,html body .form-panel select,html body .tacs-petroleum-button,html body .tacs-card-button,html body .notification-offer button,html body .notification-offer .notification-repair{background:#062c46!important;background-image:none!important;border:1px solid rgba(255,255,255,.28)!important;box-shadow:none!important;color:#fff!important}',
      'html body .before-send{background:#062c46!important;background-image:none!important;border:1px solid rgba(255,210,126,.55)!important;border-radius:13px!important;box-shadow:none!important}',
