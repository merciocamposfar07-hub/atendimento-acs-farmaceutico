...
var REVISION='20260911-sessao-unica-v1';
...
function installSafeNavigation(){
  ...
  document.addEventListener('click',function(event){
    ...
    /* SESSAO_UNICA_PAINEL_V1:
       enquanto a Central estiver apenas no acesso local, não abandona a página.
       O listener-base segura o módulo pendente até o token remoto existir.
       Assim nenhum painel administrativo volta a abrir um segundo PIN. */
