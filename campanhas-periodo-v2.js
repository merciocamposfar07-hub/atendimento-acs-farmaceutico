...
function addStyle(){
  ...
  style.textContent=[
    '.camp-period-box{margin:0 0 16px;border:1px solid #2b5a76;border-radius:20px;padding:15px;background:linear-gradient(145deg,#153b58,#102d46);color:#f7fcff;box-shadow:none}',
    '.camp-period-box h2{margin:0 0 5px;color:#fff}.camp-period-box p{margin:0 0 12px;color:#adc4d2;font-weight:700}',
    '.camp-year-row{display:grid;grid-template-columns:minmax(0,180px) 1fr;gap:10px;align-items:end}.camp-year-row label{margin:0;color:#fff}.camp-year-row select{background:#091e30!important;color:#f7fcff!important;border-color:#2b5a76!important}',
    '.camp-month-tabs{display:grid;grid-template-columns:repeat(3,minmax(0,1fr));gap:8px;padding:4px 0 2px;overflow:visible;width:100%}.camp-month-tab{width:100%;min-width:0;min-height:48px;border:1px solid #2b5a76;border-radius:14px;background:#145574;color:#fff;font-weight:900;padding:9px 8px;white-space:normal;overflow-wrap:normal;word-break:normal}.camp-month-tab.active{background:#0c3049;color:#fff;border-color:#5cb89d}',
    '.camp-period-summary{margin-top:8px;border-radius:14px;background:#153b58;padding:11px 12px;font-weight:900;overflow-wrap:anywhere;color:#f7fcff}',
    '.camp-period-fields{margin:12px 0;border:1px solid #2b5a76;border-radius:17px;padding:13px;background:#102d46;min-width:0;max-width:100%;overflow:hidden}.camp-period-fields .period-grid{display:grid;grid-template-columns:1fr 1fr;gap:9px;min-width:0}.camp-period-fields .period-grid>div{min-width:0}.camp-period-fields label{color:#f7fcff}.camp-period-fields input[type="date"]{display:block;width:100%!important;min-width:0!important;max-width:100%!important;inline-size:100%!important;min-inline-size:0!important;max-inline-size:100%!important;box-sizing:border-box!important}',
    '.camp-context{margin-top:11px;border-radius:14px;padding:12px 13px;background:#0b263d;color:#f7fcff;font-size:.93rem;font-weight:800;line-height:1.45;overflow-wrap:anywhere}.camp-context strong{color:#83efa9}',
    '.camp-month-empty{margin-top:12px;border:1px dashed #2b5a76;border-radius:16px;padding:16px;text-align:center;color:#adc4d2;font-weight:850}',
