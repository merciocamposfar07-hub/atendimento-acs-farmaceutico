...
function agendasProfissionaisTerritoriaisV1SalvarAgenda_(contexto,p){
  ...
  try{
    ...
    agendasProfissionaisTerritoriaisV1Atualizar_(tabela,linha,{DATA:agendasProfissionaisTerritoriaisV1DataOpcional_(p.data),HORARIO:agendasProfissionaisTerritoriaisV1Texto_(p.horario),SITUACAO:agendasProfissionaisTerritoriaisV1Texto_(p.situacao),MENSAGEM:agendasProfissionaisTerritoriaisV1Texto_(p.mensagem),ENCERRA_12H:agendasProfissionaisTerritoriaisV1Booleano_(p.encerra12h),VAGAS_COMUNS:agendasProfissionaisTerritoriaisV1NaoNegativo_(p.vagasComuns),VAGAS_EMERGENCIAIS:agendasProfissionaisTerritoriaisV1NaoNegativo_(p.vagasEmergenciais),DIA_EXTRA:agendasProfissionaisTerritoriaisV1Booleano_(p.diaExtra),ATIVO:agendasProfissionaisTerritoriaisV1Booleano_(p.ativo),AREA_ID:contexto.areaId,ATUALIZADO_EM:new Date()});
