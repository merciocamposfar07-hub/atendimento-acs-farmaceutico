...
module.exports = defineConfig({
  testDir: './scripts',
  testMatch: ['homologacao-cross-engine.spec.js','homologacao-performance-budget.spec.js','homologacao-push-onboarding.spec.js','homologacao-identificacao-familiar.spec.js','homologacao-familia-aparelho-beneficiario.spec.js','homologacao-matriz-identificacao.spec.js','homologacao-reserva-confirmada.spec.js','homologacao-safari-bfcache.spec.js'],
  timeout: 30000,
  expect: { timeout: 7000 },
  fullyParallel: false,
  workers: 1,
