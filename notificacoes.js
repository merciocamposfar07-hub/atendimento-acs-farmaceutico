      ...
      try {
        ...
        button.onclick = async function () {
          ...
          try {
            ...
            if (OneSignal.Notifications.permission) showEnabled(status, button, help);
            else { status.textContent = 'A permissão não foi concedida.'; help.textContent = 'Confira as permissões de notificações nas configurações do aparelho.'; button.disabled = false; }
          } catch (error) {
