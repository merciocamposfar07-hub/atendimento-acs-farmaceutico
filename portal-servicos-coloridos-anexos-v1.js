(function(){
  ...
  function addStyles(){
    ...
    s.textContent=[
      ...
      '.portal-service-picker-panel{display:grid;gap:9px;padding:11px 0;border:0;border-radius:0;background:#062c46;box-shadow:none}',
      ...
      '.portal-attachment-box{grid-column:1/-1;display:grid;gap:12px;margin-top:2px;padding:17px 0;border:0;border-radius:0;background:#062c46;color:#fff;box-shadow:none}',
