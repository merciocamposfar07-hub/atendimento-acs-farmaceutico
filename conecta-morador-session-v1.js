...
function topBar(r){
 ...
 bar.innerHTML='<div class="csc-resident-icon" aria-hidden="true">C</div><strong>'+esc(r.nome||'Morador')+'<small>Morador • Conecta Saúde Comunitária • '+esc(r.areaId||areaId())+'</small></strong><div class="csc-resident-menu"><button type="button" id="cscMuteToggle">'+(r.silencioso?'🔕 Silenciado':'🔔 Avisos')+'</button><button type="button" id="cscResidentLogout">Sair</button></div>';
